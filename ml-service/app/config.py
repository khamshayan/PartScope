...
def get_settings() -> Settings:
    return Settings(
        ...
        pg_db=os.getenv("POSTGRES_DB", "sourcescope"),
        pg_user=os.getenv("POSTGRES_USER", "sourcescope"),
        pg_password=os.getenv("POSTGRES_PASSWORD", "sourcescope"),
        mongo_uri=os.getenv("MONGO_URI", "mongodb://localhost:27018"),
        mongo_db=os.getenv("MONGO_DB", "sourcescope"),
